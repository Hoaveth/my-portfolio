...
const SocialLinks = () => {
  const links = [
    ...
    },
    {
      ...
      href: "mailto:justineespinosa.dev@gmail.com",
    },
    {
      id: 4,
      child: (
      ...
      style: "rounded-br-md",
      href: "../assets/Espinosa_Resume_Software_Developer.pdf",
      download: true,
    },
  ];
  return (
      ...
      <ul>
        {links.map((link) => (
          <li
            key={link.id}
            className={
              "flex justify-between items-center w-40 h-14 px-4 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-300 bg-violet-700" +
              " " +
              link.style
            }
          >
